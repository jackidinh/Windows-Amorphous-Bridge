        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<GeoPointApplication> app;
    ...
    else
    {
        try
        {
            app = GeoPointApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&GeoPointApplication::run, app);
