        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<GeoCircleApplication> app;
    ...
    else
    {
        try
        {
            app = GeoCircleApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&GeoCircleApplication::run, app);
