        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<GeoPolygonApplication> app;
    ...
    else
    {
        try
        {
            app = GeoPolygonApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&GeoPolygonApplication::run, app);
