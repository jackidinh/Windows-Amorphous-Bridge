        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<GeoRectangleApplication> app;
    ...
    else
    {
        try
        {
            app = GeoRectangleApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&GeoRectangleApplication::run, app);
